...
public class OpenCVActivity extends Activity
    ...
    public Mat onCameraFrame(Mat aInputFrame) {
        ...
        // If face detected, Drawing rectangle
        Rect[] facesArray = faces.toArray();
        for (int i = 0; i < facesArray.length; i++) {
//            Core.rectangle(aInputFrame, facesArray[i].tl(), facesArray[i].br(), new Scalar(0,
// 255, 0, 255), 3);
            Imgproc.rectangle(aInputFrame, facesArray[i].tl(), facesArray[i].br(), new Scalar(0,
                    255, 0, 255), 3);
        }
